...
import ar.edu.um.franquicia.repository.ShoppingCartRepository;
import ar.edu.um.franquicia.service.ShoppingCartService;
...
/**
 * REST controller for managing {@link ar.edu.um.franquicia.domain.ShoppingCart}.
 */
@RestController
@RequestMapping("/api")
