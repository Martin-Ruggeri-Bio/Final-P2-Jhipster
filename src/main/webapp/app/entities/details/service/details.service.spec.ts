...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../details.test-samples';

import { DetailsService } from './details.service';

const requireRestSample: IDetails = {
...
describe('Details Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Details', () => {
      ...
      const details = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(details).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Details', () => {
      const details = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(details).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addDetailsToCollectionIfMissing', () => {
      it('should add a Details to an empty array', () => {
        const details: IDetails = sampleWithRequiredData;
      ...
      it("should add a Details to an array that doesn't contain it", () => {
        const details: IDetails = sampleWithRequiredData;
        const detailsCollection: IDetails[] = [sampleWithPartialData];
        expectedResult = service.addDetailsToCollectionIfMissing(detailsCollection, details);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(details);
      });
      ...
      it('should add only unique Details to an array', () => {
        const detailsArray: IDetails[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const detailsCollection: IDetails[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const details: IDetails = sampleWithRequiredData;
        const details2: IDetails = sampleWithPartialData;
    ...
    describe('compareDetails', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareDetails(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareDetails(entity1, entity2);
        const compareResult2 = service.compareDetails(entity2, entity1);
