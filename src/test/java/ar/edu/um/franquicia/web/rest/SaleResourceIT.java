...
class SaleResourceIT {
    ...
    public static Sale createEntity(EntityManager em) {
        Sale sale = new Sale().total(DEFAULT_TOTAL).date(DEFAULT_DATE);
        return sale;
    }
    ...
    public static Sale createUpdatedEntity(EntityManager em) {
        Sale sale = new Sale().total(UPDATED_TOTAL).date(UPDATED_DATE);
        return sale;
    }
    ...
    void putNewSale() throws Exception {
        ...
        updatedSale.total(UPDATED_TOTAL).date(UPDATED_DATE);
    ...
    void partialUpdateSaleWithPatch() throws Exception {
        ...
        partialUpdatedSale.date(UPDATED_DATE);
    ...
    void fullUpdateSaleWithPatch() throws Exception {
        ...
        partialUpdatedSale.total(UPDATED_TOTAL).date(UPDATED_DATE);
